...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            { "U_B_CombatUniform_mcam_worn", "", 550, "call life_coplevel >= 4" },
			{ "U_B_CombatUniform_mcam", "", 550, "call life_coplevel >= 29" },
			{ "U_B_CombatUniform_mcam_vest", "", 550, "call life_coplevel >= 4" },
			{ "U_B_FullGhillie_lsh", "", 550, "call life_coplevel >= 7" },
			{ "U_B_GEN_Soldier_F", "", 550, "call life_coplevel >= 8" },
			{ "U_Competitor", "", 550, "call life_coplevel >= 29" },
			{ "U_B_Wetsuit", "", 550, "call life_coplevel >= 2" },
            { "U_B_survival_uniform", "", 1250, "call life_coplevel >= 7" }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, "" },
            { "H_Cap_police", "", 25, "" },
			...
			{ "H_HelmetB_light_black", "", 100, "call life_coplevel >= 3" },
			{ "H_HelmetB_light_sand", "", 100, "call life_coplevel >= 4" },
			{ "H_HelmetSpecB", "", 100, "call life_coplevel >= 5" },
			{ "H_HelmetSpecB_sand", "", 100, "call life_coplevel >= 5" },
