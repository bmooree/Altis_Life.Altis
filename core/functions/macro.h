...
#define OGSEL(ARRAY,INDEX,DEFAULT) ([ARRAY,INDEX,DEFAULT] call BIS_fnc_param;)
#define CASH life_ogCash1591
#define BANK life_ogBank1591
...
//Scripting Macros
#define COP(var) (side var == west)
#define CIV(var) (side var == civilian)
#define MEDIC(var) (side var == independant)
...
#define GTR(condition1,condition2) condition1 > condition2
#define LSS(condition1,condition2) condition1 < condition2
#define NOTEQUAL(condition1,condition2) condition1 != condition2
