    ...
    */
    ...
    class cop_air {
        ...
        vehicles[] = {
			...
			{ "I_Heli_light_03_unarmed_F", "call life_coplevel >= 2" },
    ...
    class cop_ship {
        ...
        vehicles[] = {
            ...
            { "C_Boat_Transport_02_F", "call life_coplevel >= 2" }, //Apex DLC
        };
    };
};
...
*/
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "GD", "cop", {
                "textures\suv_cop.jpg"
            }, "" },
			{ "CMD", "cop", {
                "textures\cmd_suv.jpg"
            }, "call life_coplevel >= 6" },
			{ "HWP", "cop", {
                "textures\hwp_suv_cop.jpg"
            }, "" }
        };
    };
    ...
    class B_MRAP_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "textures\hunter_swat_6.jpg",
                "textures\hunter_swat_11.jpg"
            }, "" }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "textures\111384903725-hummingbird-ion.jpg"
            }, "" },
            { "Sheriff", "civ", {
