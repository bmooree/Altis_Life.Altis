...
/* System Settings */
    ...
    news_broadcast_cost = 300000; //Cost for a player to send a news station broadcast.
    ...
    revive_fee = 7000; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
